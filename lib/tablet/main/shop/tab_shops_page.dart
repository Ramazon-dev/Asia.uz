...
class TabShopsPage extends StatefulWidget {
  TabShopsPage({Key? key}) : super(key: key);

  @override
  State<TabShopsPage> createState() => _TabShopsPageState();
}

class _TabShopsPageState extends State<TabShopsPage> {
